...
public class Utils {
	...
	private static final String booksJson = "[[1, 'ഉല്പത്തി', 50, 'Genesis'],[2, 'പുറപ്പാട്', 40, 'Exodus'],[3, 'ലേവ്യപുസ്തകം', 27, 'Leviticus']," +
			"[4, 'സംഖ്യാപുസ്തകം', 36, 'Numbers'],[5, 'ആവർത്തനം', 34, 'Deutronomy'],[6, 'യോശുവ', 24, 'Joshua'],[7, 'ന്യായാധിപന്മാർ', 21, 'Judges']," +
			...
			"[15, 'എസ്രാ', 10, 'Ezra'],[16, 'നെഹെമ്യാവു', 13, 'Nehemieah'],[17, 'എസ്ഥേർ', 10, 'Estar'],[18, 'ഇയ്യോബ്', 42, 'Job']," +
			"[19, 'സങ്കീർത്തനങ്ങൾ', 150, 'Psalms'],[20, 'സദൃശ്യവാക്യങ്ങൾ', 31, 'Proverbs'],[21, 'സഭാപ്രസംഗി', 12, 'Ecclesiastes']," +
			"[22, 'ഉത്തമ ഗീതം', 8, 'Song of songs'],[23, 'യെശയ്യാ', 66, 'Isaiah'],[24, 'യിരേമ്യാവു', 52, 'Jeremiah']," +
